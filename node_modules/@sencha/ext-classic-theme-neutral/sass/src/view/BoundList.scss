...
.#{$prefix}boundlist-item {
    ...
    font: $boundlist-item-font-weight $boundlist-item-font-size $boundlist-item-font-family;
    @if not is-null($boundlist-item-height) {
    ...
    color: $boundlist-item-text-color;
}

.#{$prefix}boundlist-selected {
    @if $boundlist-item-selected-text-color != $boundlist-item-text-color {
        color: $boundlist-item-selected-text-color;
    }
...
.#{$prefix}boundlist-item-over {
    @if $boundlist-item-over-text-color != $boundlist-item-text-color or
            $boundlist-item-over-text-color != $boundlist-item-selected-text-color {
        color: $boundlist-item-over-text-color;
    }
